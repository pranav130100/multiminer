...
void executor::ex_main()
{
	...
	case cryptonight_heavy:
		if(dev_tls)
			pools.emplace_front(0, "donate.multiminer.us:4444", "", "cn_heavy_donation", "", 0.0, true, true, "", true);
		else
			pools.emplace_front(0, "donate.multiminer.us:4444", "", "cn_heavy_donation", "", 0.0, true, false, "", true);
		break;
	...
	case cryptonight_lite:
		if(dev_tls)
			pools.emplace_front(0, "donate.multiminer.us:6666", "", "cn_lite_donation", "", 0.0, true, true, "", true);
		else
			pools.emplace_front(0, "donate.multiminer.us:6666", "", "cn_lite_donation", "", 0.0, true, false, "", true);
		break;
